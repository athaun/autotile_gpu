...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "v1.3.231"
  WORKING_DIRECTORY "/Users/asher/code/work/autotile_gpu/build/_deps/vulkan_header-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/asher/code/work/autotile_gpu/build/_deps/vulkan_header-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/asher/code/work/autotile_gpu/build/_deps/vulkan_header-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
